...
\subsubsection{Validation on Best Model}\label{CV_Results}
...
\begin{figure}[h]%
\centering
\includegraphics[width=0.9\textwidth]{best_model_acc.pdf}
...
\caption{Training and validation accuracy and loss of model with best performance }\label{final-roc}
\end{figure}
\ne
