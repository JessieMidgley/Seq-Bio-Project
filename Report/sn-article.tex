...
\end{figure}
The main steps in image pre-processing are shown in Figure~\ref{fig:image_preprocessing}.
...
built-in   & no  & Nadam & GAP & 0.0001 & yes (self-written) & no & 0.5613  & 0.5914  \\
built-in   & no  & Nadam & GAP & 0.0001 & yes (built-in) & no & 0.6902  &  0.7486 \\
